...
Wed May  1  - Lecture 34 and 35.

## No class on Friday May 10

No Class Friday May 10.

All homework really must be turned in by the final 10:00am May 17.

Office hours by appointment during finals week.

## News

1. AWS 

"Amazon Web Services (AWS), the cloud computing platform subsidiary of retail
giant Amazon, has made its Amazon Managed Blockchain (AMB) generally available,
according to an announcement on April 30.

"The product will purportedly allow customers to set up blockchain networks
within their organizations, and uses the Ethereum and Hyperledger open source
frameworks. Notably, Amazon states that AMB can scale to support thousands to
millions of transactions."


2. 11% of americans hold some sort of crypto "coin"
[https://cointelegraph.com/news/11-of-americans-own-bitcoin-major-awareness-increased-since-2017](https://cointelegraph.com/news/11-of-americans-own-bitcoin-major-awareness-increased-since-2017)

3. HTC Phone with Wallet.
[https://www.coindesk.com/htc-plans-to-launch-another-blockchain-phone-this-year-exec-says](https://www.coindesk.com/htc-plans-to-launch-another-blockchain-phone-this-year-exec-says)


## VC and Founders

1. YC and multiple founders. 
SSRI Sole founders are more likely to be successful and reach a "monitory" event.
2. How to get wealth from a startup.
